...
import imgLuchenDot from '@/assets/images/role-list/280554ab32c3da2811471dc559ea679667b20361.png'
...
import imgLinxiDot from '@/assets/images/role-list/a6ff23f2e18817c63025c16a99f5f38f3b43c85b.png'
...
import imgGuyanDot from '@/assets/images/role-list/f94a983211525ced14e028dc8c2a1ee768ba9fb9.png'
...
import imgTaoDot from '@/assets/images/role-list/f33e87861b7a492340dcd6fc5852f57f10eba428.png'
...
import imgYeDot from '@/assets/images/role-list/c590d81534365b2a419b7bc60835238cf24918db.png'
...
import imgLilithDot from '@/assets/images/role-list/fc68b18aabe73f5b8aa51107a3fc692f50f9b65f.png'
  ...
  return (
    ...
    >
      ...
      <img
        alt=""
        src={character.dot}
        className="pointer-events-none absolute top-[7px] right-[7px] size-[13px]"
      />
      <div className="absolute inset-x-0 bottom-0 px-[10px] pt-8 pb-[9px]">
        <p className="font-bold text-[13px] leading-tight text-[#d7d3d2]">{character.name}</p>
        ...
        <div className="mt-[7px] flex items-center gap-[5px]">
          {character.tags.map((tag) => (
            <span
              key={tag}
              className="rounded-[4px] bg-[#212122]/85 px-[6px] py-[2px] text-[7px] leading-[1.5] text-[#7f7f7e]"
            >
              {tag}
            </span>
          ))}
          <span className="ml-auto flex items-center gap-[3px]">
            ...
            <span className="font-num font-bold text-[9px] text-[#a0a0a0]">{character.heat}</span>
          </span>
        </div>
      </div>
    </button>
...
export default function Discover() {
  ...
  return (
    <DiscoveryListLayout activeNav={activeNav} onNavChange={setActiveNav}>
      <DiscoveryListHeader activeTab="角色" />
      <DiscoveryListSearch
        value={query}
        onChange={setQuery}
      ...
      <section className="mt-[14px] px-[16px]">
        <div className="relative aspect-[772/267] w-full overflow-hidden rounded-[16px]">
          ...
          <div className="absolute inset-0 flex flex-col justify-center px-[16px]">
            ...
            <h2 className="mt-[9px] font-bold text-[18px] leading-none text-[#b1b2b1]">
              深夜陪伴 <span className="text-[#b1b2b1]">·温柔治愈</span>
            </h2>
