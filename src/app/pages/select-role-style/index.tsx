...
const imgImage = ((m: any) => m?.default ?? m?.uri ?? m)(require("../../../assets/images/select-role-style/bfc3c41d1a6b570e1b0987aedf706c872d00b6d5.png"))
...
export default function App() {
  ...
  return (
    <div className="relative size-full bg-black overflow-hidden">
      ...
      `}</style>
      <button className="animate-breathing fixed bottom-6 right-6 bg-black border border-black rounded-full w-16 h-16 flex items-center justify-center z-50">
