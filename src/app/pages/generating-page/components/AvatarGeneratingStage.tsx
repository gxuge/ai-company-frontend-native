    ...
    <div className="relative flex flex-col items-center justify-between h-full px-5 py-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-10 w-full max-w-sm relative z-10">
        ...
        >
          ...
          />
          <div className="relative w-full h-full rounded-3xl bg-gradient-to-br from-[var(--ai-blue)]/20 via-[var(--ai-purple)]/20 to-[var(--ai-cyan)]/20 backdrop-blur-sm border border-white/10 flex items-center justify-center overflow-hidden">
