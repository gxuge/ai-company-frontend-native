...
export const AiDateInput: React.FC<AiDateInputProps> = ({
  ...
  const webFocusStyle = Platform.OS === 'web' ? { 
    ...
    borderColor: focused ? brandGreenRgba(0.5) : 'rgba(255,255,255,0.3)'
  } : {};
            ...
            {years.map(y => (
              <Pressable
                ...
                className={`w-[30%] h-12 items-center justify-center rounded-xl mb-3 ${
                  y === year ? 'bg-brand-green/90 shadow-[0_0_10px_rgba(var(--color-brand-green-rgb),0.5)]' : 'active:bg-white/10 hover:bg-white/5 bg-white/5'
                }`}
              >
        ...
        {MONTHS.map((mName, i) => (
          <Pressable
            ...
            className={`w-[30%] h-14 items-center justify-center rounded-xl mb-4 ${
              i === month ? 'bg-brand-green/90 shadow-[0_0_10px_rgba(var(--color-brand-green-rgb),0.5)]' : 'active:bg-white/10 hover:bg-white/5 bg-white/5'
            }`}
          >
  ...
  const renderCalendar = () => {
        ...
        days.push(
          <Pressable
            ...
            className={`w-[14%] aspect-square items-center justify-center rounded-full transition-colors ${
              isSelected ? 'bg-brand-green/90 shadow-[0_0_10px_rgba(var(--color-brand-green-rgb),0.5)]' : 'active:bg-white/10 hover:bg-white/5'
            }`}
          >
    ...
    return (
      <Modal transparent visible={showPicker} animationType="fade" onRequestClose={handleClose}>
        ...
        >
          <Pressable 
            className="w-full max-w-[340px] bg-[#1a1a1a] rounded-[24px] p-5 border border-brand-green/20 shadow-[0_0_40px_rgba(var(--color-brand-green-rgb),0.15)]"
